# Materialization Check Assertions

*Normative original: [${CLAUDE_PLUGIN_ROOT}/adoption/checks/materialization-check.md](${CLAUDE_PLUGIN_ROOT}/adoption/checks/materialization-check.md). This file copies its assertions in full so the skill is usable without hunting; if the two ever disagree, the original governs.*

Runs after writing (Step 9 of [the procedure](../SKILL.md)). Three questions, in order, none optional.
